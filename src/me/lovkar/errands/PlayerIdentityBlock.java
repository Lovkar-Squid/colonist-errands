...
/**
 * Lovkar's multiplayer polish (he plays with his girlfriend and his little
...
public final class PlayerIdentityBlock {
    ...
    public static String build(CitizenPromptView view) {
        ...
        sb.append("\n\nMULTIPLAYER AWARENESS (several people play in this colony):")
                ...
                .append("('Lovkar promised me bread', 'Ana sent me to the mine') - NEVER write just 'the player'. ")
        ...
        try {
            ...
            if (rel != null && rel.playerName() != null) {
                ...
                // Lovkar's idea #30: what their rank may actually command (mirrors the
